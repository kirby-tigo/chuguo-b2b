            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-1">sunlong@tigosc.net</p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">钛果集采总部大厦</p>
                </div>
              </div>
        ...
        <div className="mb-16">
          ...
          <div className="relative h-[400px] rounded-xl overflow-hidden">
            ...
            <div className="absolute top-4 left-4 bg-white p-4 rounded-lg shadow-md">
              <h3 className="font-semibold mb-2">云镜星途总部</h3>
