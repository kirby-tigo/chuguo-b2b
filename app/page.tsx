      ...
      <div className="bg-white py-16 mb-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-3">为什么选择云镜星途</h2>
      ...
      <div className="bg-gradient-to-r from-emerald-50 to-white py-16 mb-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              钛果集采为连锁水果门店提供全方位的供应链解决方案，助力门店降本增效，实现业务增长
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                除了优质的水果供应，钛果集采还为连锁门店提供运营培训、营销策划、品牌建设等全方位支持，帮助门店提升竞争力，实现可持续发展。
              </p>
            ...
            {[
              {
                ...
                content:
                  "与云镜星途合作一年多，水果品质稳定，价格合理，最重要的是他们提供的门店管理系统大大提升了我们的运营效率，强烈推荐！",
                rating: 5,
              },
              {
                name: "张总",
                ...
                content:
                  "作为一家拥有20多家门店的连锁企业，采购一直是我们的痛点。自从使用云镜星途平台，我们的采购成本降低了15%，果品损耗率也大幅下降。",
                rating: 5,
              },
              {
                name: "王老板",
                ...
                content:
                  "云镜星途的供应链服务非常专业，他们的冷链物流确保了水果的新鲜度，客户满意度明显提升。平台的数据分析功能也帮助我们更好地了解市场趋势。",
                rating: 4,
              },
            ].map((testimonial, i) => (
              <Card key={i} className="border-none shadow-md hover:shadow-lg transition-shadow">
      ...
      <div className="bg-white py-16 mb-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">解答您关心的问题，帮助您更好地了解云镜星途平台</p>
          </div>
            ...
            <div>
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger>如何注册成为云镜星途的会员？</AccordionTrigger>
                  <AccordionContent>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">sunlong@tigosc.net</p>
                </div>
              </div>
      ...
      <div className="bg-emerald-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-emerald-100">数以万计的批发商选择云镜星途</p>
          </div>
