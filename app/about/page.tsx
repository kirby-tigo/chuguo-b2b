  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-[400px] overflow-hidden">
        <Image src="/placeholder.png" alt="云镜星途" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <div className="text-center text-white max-w-3xl px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">关于钛果集采</h1>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              钛果集采是一家专注于水果批发领域的B2B电商平台，致力于为批发商和连锁门店提供优质的水果采购服务
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p>
                钛果集采成立于2018年，总部位于湖北武汉，是一家专注于水果批发领域的B2B电商平台。我们致力于通过互联网技术，连接全球优质水果产地和批发商，打造高效透明的水果供应链生态系统。
              </p>
              <p>
                经过多年发展，钛果集采已建立起覆盖全国的供应网络，与500多家优质供应商达成长期合作，服务超过5万家批发商和连锁门店客户。我们提供超过2000种水果品类，月交易额突破1亿元。
              </p>
              <p>
                我们的使命是"让水果采购更简单"，通过数字化、标准化的服务，帮助批发商降低采购成本，提高运营效率，实现业务增长。未来，钛果集采将继续深耕水果批发领域，不断创新服务模式，为行业发展贡献力量。
              </p>
            ...
            <div className="relative h-[400px] rounded-xl overflow-hidden">
              <Image src="/fruit-wholesale-meeting.png" alt="云镜星途团队" fill className="object-cover" />
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              从创立至今，钛果集采不断创新发展，成为水果批发领域的领先平台
            </p>
          </div>
              ...
              {[
                {
                  year: "2018年",
                  title: "公司成立",
                  content: "钛果集采在武汉成立，开始探索水果批发B2B模式",
                },
                {
                  year: "2019年",
                  title: "业务拓展",
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              钛果集采凭借强大的供应链能力和专业的服务团队，为客户提供卓越的采购体验
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: "高效的物流配送",
                content:
                  "自建冷链物流体系，确保水果在运输过程中保持最佳状态。我们承诺在确认订单后48小时内发货，让您的商品快速到达。",
              },
              {
                icon: <Users className="h-10 w-10" />,
                title: "一站式解决方案",
                content:
                  "除了优质的水果供应，我们还为客户提供门店管理系统、营销策划、品牌建设等全方位支持，帮助您的业务实现可持续发展。",
              },
            ].map((advantage, i) => (
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    ...
                    <span>
                      <strong>诚信为本</strong> - 诚实守信，言行一致，是我们的立业之本
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700">
                    ...
                    <span>
                      <strong>客户至上</strong> - 以客户需求为中心，持续创造价值
                    </span>
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700">
                    ...
                    <span>
                      <strong>创新驱动</strong> - 拥抱变革，持续创新，推动行业发展
                    </span>
                  </li>
                </ul>
              </div>
