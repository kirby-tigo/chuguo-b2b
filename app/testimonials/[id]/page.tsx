...
const testimonialDetails = {
  ...
  content:
    "作为一家拥有30多家门店的水果连锁企业，采购和供应链管理一直是我们的痛点。自从与云镜星途合作以来，我们的采购成本降低了15%，库存周转率提高了30%，极大地提升了我们的运营效率。云镜星途不仅提供优质的水果供应，还为我们提供了专业的门店管理系统和数据分析工具，帮助我们更好地了解市场趋势和消费者需求，优化商品结构，提高毛利率。他们的冷链物流确保了水果的新鲜度，客户满意度明显提升。我们非常满意与云镜星途的合作，他们是值得信赖的长期合作伙伴。",
  rating: 5,
  type: "chain",
  location: "广东省广州市",
  date: "2023-06-15",
                  ...
                  {[
                    {
                      name: "李明",
                      company: "果然鲜水果超市",
                      content: "云镜星途的供应链服务非常专业，他们的冷链物流确保了水果的新鲜度...",
                    },
                    {
                      name: "王晓华",
                      company: "优鲜果业",
                    ...
                    },
                    {
                      name: "赵琳",
                      company: "鲜果汇",
                      content: "与云镜星途合作一年多，水果品质稳定，价格合理，最重要的是...",
                    },
                  ].map((item, i) => (
