          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-white/90 mb-8">
                除了优质的水果供应，云镜星途还为连锁门店提供运营培训、营销策划、品牌建设等全方位支持，帮助门店提升竞争力，实现可持续发展。
              </p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              云镜星途为连锁水果门店提供全方位的运营支持，帮助门店提升运营效率，降低成本，增加收益
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-muted-foreground">
                    云镜星途提供专业的门店运营培训，帮助连锁门店提升运营效率，降低成本，提高顾客满意度。我们的培训内容涵盖商品陈列、库存管理、员工培训等多个方面，由行业资深专家授课，结合实际案例，确保培训内容落地有效。
                  </p>
            ...
            <TabsContent value="marketing">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 md:order-2 space-y-6">
                  ...
                  <p className="text-muted-foreground">
                    云镜星途提供专业的营销策划支持，帮助连锁门店吸引顾客，提升销售。我们的营销团队拥有丰富的水果零售行业经验，能够根据不同门店的特点和目标客群，定制有效的营销方案。
                  </p>
            ...
            <TabsContent value="branding">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-muted-foreground">
                    云镜星途提供专业的品牌建设支持，帮助连锁门店打造差异化竞争优势。我们的品牌团队拥有丰富的品牌建设经验，能够从品牌定位、视觉形象、门店装修等多个维度，提供全方位的品牌建设支持。
                  </p>
            ...
            <TabsContent value="digital">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 md:order-2 space-y-6">
                  ...
                  <p className="text-muted-foreground">
                    云镜星途提供专业的数字化转型支持，帮助连锁门店拓展线上渠道，实现全渠道经营。我们的数字化团队拥有丰富的互联网和零售行业经验，能够为门店提供全方位的数字化转型支持。
                  </p>
            ...
            {[
              {
                ...
                content: "通过云镜星途的运营支持，我们的门店客流量提升了30%，客单价提升了20%，整体销售额提升了50%。",
                person: "李经理",
                position: "运营总监",
              ...
              },
              {
                ...
                content:
                  "云镜星途的品牌建设支持帮助我们重新定位品牌，打造了全新的视觉形象，门店改造后，销售额提升了40%。",
                person: "张总",
                position: "创始人",
              ...
              },
              {
                ...
                content: "通过云镜星途的数字化转型支持，我们成功上线了小程序和线上商城，线上销售额占比从0提升到了30%。",
                person: "王老板",
                position: "CEO",
        ...
        <div className="mb-16 bg-emerald-50 rounded-xl p-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">云镜星途的运营支持具有哪些独特优势</p>
          </div>
