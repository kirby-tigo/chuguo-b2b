          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl">
                从供应链优化到数字化运营，钛果集采为水果连锁门店提供一站式解决方案，助力您的业务增长
              </p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              钛果集采为连锁水果门店提供全方位的供应链和运营解决方案，帮助您降本增效，实现业务增长
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  钛果集采整合全国优质水果产地资源，建立高效的供应链网络，为连锁门店提供稳定、优质、价格合理的水果供应。
                </p>
            ...
            <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  钛果集采提供专业的门店管理系统，帮助连锁门店实现数字化运营，提高管理效率，降低运营成本。
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2 text-sm">
                    <div className="w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700">
            ...
            <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  钛果集采利用大数据技术，为连锁门店提供市场趋势、消费者偏好等洞察，辅助门店制定经营策略。
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2 text-sm">
                    <div className="w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700">
            ...
            <TabsContent value="marketing">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 md:order-2 space-y-6">
                  ...
                  <p className="text-muted-foreground">
                    钛果集采提供全方位的营销支持和会员管理系统，帮助连锁门店提升品牌影响力，增强客户粘性。
                  </p>
            ...
            {[
              {
                ...
                content:
                  "通过钛果集采的供应链优化和门店管理系统，我们的采购成本降低了15%，库存周转率提高了30%，门店运营效率显著提升。",
                person: "李经理",
                position: "运营总监",
              },
              {
                ...
                content:
                  "钛果集采的数据分析系统帮助我们更好地了解消费者需求，优化了商品结构，提高了毛利率，同时会员管理系统增强了客户粘性。",
                person: "张总",
                position: "创始人",
              },
              {
                ...
                content:
                  "作为一家拥有30多家门店的连锁企业，钛果集采的解决方案帮助我们实现了标准化管理，提高了品牌影响力，业务实现了快速增长。",
                person: "王老板",
                position: "CEO",
              },
            ].map((case_, i) => (
        ...
        <div className="mb-16 bg-emerald-50 rounded-xl p-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">钛果集采为连锁门店提供的解决方案具有哪些独特优势</p>
          </div>
